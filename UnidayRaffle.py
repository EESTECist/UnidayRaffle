...
def load_from_file():
    ...
    people_label["text"] = "People ({})".format(len(Data.people))
...
header = tk.Label(root, text="Uni-Day'17 - Çekiliş", font=("Roboto", 44), padx=10, pady=10)
header.pack()

img_path = os.path.dirname(os.path.abspath(__file__)) + "/eestec.gif"
